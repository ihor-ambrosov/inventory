...
class Item extends \Ambros\Common\DataObject\Wrapper
{
     ...
     * 
     * @return \Ambros\Inventory\Wrapper\Model\Sales\ResourceModel\Order\Item\Source
     */
    private function getResourceSourceWrapper(): \Ambros\Inventory\Wrapper\Model\Sales\ResourceModel\Order\Item\Source
    {
        return $this->wrapperFactory->create(
            $this->getObject()->getResource(),
            \Ambros\Inventory\Wrapper\Model\Sales\ResourceModel\Order\Item\Source::class
        );
    }
     ...
     * Get source wrapper
     * 
     * @return \Ambros\Inventory\Wrapper\Model\Sales\Order\Item\Source
     */
    private function getSourceWrapper(): \Ambros\Inventory\Wrapper\Model\Sales\Order\Item\Source
    {
        return $this->wrapperFactory->create(
            $this->getObject(),
            \Ambros\Inventory\Wrapper\Model\Sales\Order\Item\Source::class
        );
    }
