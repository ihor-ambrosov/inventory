...
namespace Ambros\Inventory\Wrapper\Block\Paypal\Express;

/**
 * PayPal express review block wrapper
 */
class Review extends \Ambros\Common\DataObject\Wrapper implements \Magento\Framework\View\Element\Block\ArgumentInterface
{
    /**
